...
import com.cust.model.MyMessage;
...
public class CustomerController {
	...
	public void saveCustomer(@RequestBody Customer theCustomer) {
		...
		MyMessage myMessage =new MyMessage(theCustomer.getEmail(),"You have register successfully with particular user name :  " +theCustomer.getUserName()+"");
